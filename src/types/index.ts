...
export interface Contact {
  ...
  created_at: string;
  updated_at: string;
  /** Whether this number is registered on WhatsApp. true / false once
   *  checked; null/undefined = not yet verified. Set from inbound
   *  messages and the pre-first-send number check. */
  is_on_whatsapp?: boolean | null;
  /** When is_on_whatsapp was last set. */
  whatsapp_checked_at?: string | null;
  /** Contact's WhatsApp "about" text. */
   ...
   *  the group id). Groups appear in the inbox, not the contacts list. */
...
export interface Conversation {
  ...
  whatsapp_config?: { id: string; label: string | null } | null;
  contact?: Contact;
}
...
export interface Message {
  ...
  /** Set when the message was deleted for everyone (unsend). */
...
export interface WhatsAppConfig {
  ...
  connected_at?: string;
  // --- Evolution API (self-hosted backend) ---
  /** The Evolution instance this account owns (one instance == one number). */
  instance_name?: string;
  /** Evolution's internal UUID for the instance. */
  instance_id?: string;
  /** Live Baileys connection state. */
  connection_state?: 'open' | 'connecting' | 'close';
  // --- Legacy Meta Cloud API fields (retained, now optional) ---

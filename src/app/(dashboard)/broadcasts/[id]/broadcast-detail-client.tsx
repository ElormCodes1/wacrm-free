...
/**
 * Interactive island for a broadcast's detail view. Seeded with the
 * server-fetched `broadcast` + `recipients` (no client fetch waterfall);
 * owns only the status filter, CSV export, and delete flow.
 */

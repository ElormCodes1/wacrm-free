...
/**
 * Interactive island for the broadcasts list. Seeded with the
 * server-rendered `initial` list (so the first paint shows real rows, no
 * spinner) and only talks to Supabase to poll live progress while a

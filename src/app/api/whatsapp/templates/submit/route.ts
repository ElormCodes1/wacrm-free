...
export async function POST(request: Request) {
  try {
    ...
    // The free backend has no Meta template-approval system — a template
    // is just a local reusable snippet, immediately usable. Persist it as
    // APPROVED with no meta_template_id.
